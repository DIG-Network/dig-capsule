...
use crate::imp::core::bytes::{Bytes32, Bytes48, Bytes96};
use crate::imp::core::codec::{Decode, DecodeError, Decoder, Encode, Encoder};
use crate::imp::core::merkle::MerkleProof;
...
/// `ExecutionProof` via `dig_capsule_prover`.
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// (`crate::imp::crypto::bls::attestation_signing_message`, via the re-export
/// `crate::imp::crypto::bls::ATTEST_DST`) and the verifier (the guest's
