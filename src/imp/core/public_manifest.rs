...
//!
//! Where the per-generation [`crate::imp::core::datasection`] `KeyTable` lists the resources
...
//! This is an ADDITIVE `.dig` section ([`crate::imp::core::datasection::SectionId::PublicManifest`]
...
//! Body layout (all integers big-endian; the [`crate::imp::core::codec`] framing):
//! ```text
//! schema_version : u32
...
impl PublicManifest {
    ...
    /// Encode the body bytes (the [`crate::imp::core::datasection::SectionId::PublicManifest`]
    /// section payload).
