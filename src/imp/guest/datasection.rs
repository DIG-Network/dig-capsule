...
//! `crate::imp::core::datasection`. The guest does **not** define its own parser or
...
//!   * wraps `crate::imp::core::datasection::DataView` in [`DataSection`] with the
...
//!     [`crate::imp::core::datasection::DIGS_DATA_OFFSET`] (D2) on wasm.
//!
...
/// `crate::imp::core::datasection::DataView`).
...
impl<'a> DataSection<'a> {
    ...
    ///
    /// [`DIGS_DATA_OFFSET`]: crate::imp::core::datasection::DIGS_DATA_OFFSET
