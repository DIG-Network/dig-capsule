...
fn ensure_session_establishes_when_absent() {
    ...
    struct H;
    impl crate::imp::guest::host::DigHost for H {
        ...
        fn random_bytes(&self, c: u32) -> crate::imp::guest::host::HostResult {
            Ok(vec![1; c as usize])
        }
    }
    let h = H;
...
use crate::imp::guest::jwt::{check_claims, decode_unverified, ClaimPolicy, JwtError, JwtParts};
...
use crate::imp::guest::jwt::{verify_signature, Jwk};
