...
//!
//! The byte-exact format is owned by [`crate::imp::core::datasection`]; this module
//! is a thin compiler-side adapter that gathers the typed inputs and emits the
//! sections in ascending id order via [`crate::imp::core::datasection::encode_blob`].
...
///
/// DEVIATION: `crate::imp::core::TrustedHostKey` does NOT implement `Encode`/`Decode`
...
/// [`crate::imp::core::datasection::encode_blob`], so the bytes are byte-identical to
