...
use crate::imp::compiler::{GenerationView, ResourceView};
use crate::imp::core::{AuthenticationInfo, Bytes32, Bytes48, MetadataManifest, TrustedHostKey};
...
pub fn trusted_keys() -> Vec<TrustedHostKey> {
    let sk = crate::imp::crypto::bls::BlsSecretKey::from_seed(&[42u8; 32]);
