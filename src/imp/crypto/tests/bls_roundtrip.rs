...
fn from_bytes_rejects_non_canonical_public_key() {
    use crate::imp::core::Bytes48;
    use crate::imp::crypto::CryptoError;
    ...
    assert_eq!(
        err,
        CryptoError::Bls(crate::imp::crypto::BlsError::InvalidPublicKey)
    );
}
...
fn sign_then_verify_round_trip_free_helpers() {
    use crate::imp::crypto::{bls_sign, bls_verify};
...
fn verify_rejects_malformed_signature_bytes() {
    use crate::imp::core::Bytes96;
    use crate::imp::crypto::bls_verify;
...
fn verify_rejects_malformed_public_key_bytes() {
    use crate::imp::core::{Bytes48, Bytes96};
    use crate::imp::crypto::{bls_sign, bls_verify};
...
fn chia_aug_scheme_known_vector() {
    ...
    assert!(crate::imp::crypto::bls_verify(&pk48, &msg, &sig96));
    // And must NOT verify a different message (binding sanity).
    assert!(!crate::imp::crypto::bls_verify(&pk48, &[9u8, 9, 9], &sig96));
}

#[test]
fn sign_push_then_verify_push_round_trip_and_binding() {
    use crate::imp::core::Bytes32;
    use crate::imp::crypto::{push_signing_message, sha256, sign_push, verify_push};
    ...
    concat.extend_from_slice(crate::imp::crypto::bls::PUSH_DST);
    ...
    assert!(!crate::imp::crypto::bls_verify(
        &pk.to_bytes(),
        &concat,
        &sig
    ));
...
fn sign_node_binds_program_output_anchor_and_input() {
    use crate::imp::core::Bytes32;
    use crate::imp::crypto::{bls_verify, node_signing_message, sign_node};
...
fn node_signing_message_layout_is_exact() {
    use crate::imp::core::Bytes32;
    use crate::imp::crypto::node_signing_message;
    ...
    let t = crate::imp::crypto::bls::NODE_DST;
    let tl = t.len();
...
fn sign_attestation_binds_nonce_store_and_timestamp() {
    use crate::imp::core::AttestationChallenge;
    use crate::imp::crypto::{attestation_signing_message, bls_verify, sign_attestation};
    ...
    let t = crate::imp::core::ATTEST_DST;
    let tl = t.len();
...
fn role_tags_domain_separate_identical_payloads() {
    ...
    assert_ne!(
        crate::imp::crypto::bls::PUSH_DST,
        crate::imp::crypto::bls::NODE_DST
    );
    assert_ne!(
        crate::imp::crypto::bls::PUSH_DST,
    ...
    assert_eq!(
        &attest_msg[..crate::imp::core::ATTEST_DST.len()],
        crate::imp::core::ATTEST_DST
    );
    ...
    let challenge = crate::imp::core::AttestationChallenge {
        nonce: [0x11u8; 32],
        store_id: [0x22u8; 32],
        timestamp: 0,
    };
...
fn sign_tombstone_then_verify_round_trip_and_binding() {
    use crate::imp::core::tombstone::{RevocationReason, Tombstone};
    use crate::imp::core::Bytes32;
    use crate::imp::crypto::{sha256, sign_tombstone, tombstone_signing_message, verify_tombstone};
    ...
    let mut concat = Vec::new();
    concat.extend_from_slice(crate::imp::crypto::bls::TOMB_DST);
    ...
    let bogus = crate::imp::core::Bytes96([0xFFu8; 96]);
...
fn tombstone_message_domain_separated_from_other_roles() {
    ...
    let tomb = crate::imp::crypto::bls::TOMB_DST;
    assert_ne!(tomb, crate::imp::crypto::bls::PUSH_DST);
    assert_ne!(tomb, crate::imp::crypto::bls::NODE_DST);
    assert_ne!(tomb, crate::imp::core::ATTEST_DST);
    ...
    let push_sig = crate::imp::crypto::sign_push(&sk, &root, &store_id);
...
fn verify_push_ok(
    sk: &bls::SecretKey,
    root: &crate::imp::core::Bytes32,
    store: &crate::imp::core::Bytes32,
    sig: &crate::imp::core::Bytes96,
) -> bool {
    crate::imp::crypto::verify_push(&sk.public_key(), root, store, sig)
}
