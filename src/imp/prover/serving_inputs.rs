...
impl ServingInputs {
    ...
    /// the single canonical ordering helper [`crate::imp::core::serving::concat_output`]
...
mod tests {
    ...
    fn output_bytes_matches_core_concat_output_ordering() {
        // C9: ServingInputs::output_bytes() MUST equal crate::imp::core::serving::concat_output
