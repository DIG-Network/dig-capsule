use crate::imp::chunker::GEAR_TABLE;
...
use crate::imp::chunker::{chunk_slice, default_config};
...
fn shared_trailing_hashes(
    a: &[crate::imp::chunker::Chunk],
    b: &[crate::imp::chunker::Chunk],
) -> usize {
