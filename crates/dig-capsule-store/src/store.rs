...
impl<C: Clock> Store<C> {
    ...
    pub fn commit(&mut self) -> Result<Bytes32> {
        ...
        for rec in &records {
            ...
            // The SAME `dig_capsule_core::resource_leaf` the browser verifier checks
            ...
            let leaf = dig_capsule_core::resource_leaf(&blob);
