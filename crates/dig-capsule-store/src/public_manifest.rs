...
//! its provenance (see [`dig_capsule_core::PublicManifest`]). This is the source the
...
use dig_capsule_core::{resource_leaf, Bytes32, PublicManifest, PublicManifestEntry};
...
mod tests {
    ...
    use dig_capsule_core::resource_leaf;
