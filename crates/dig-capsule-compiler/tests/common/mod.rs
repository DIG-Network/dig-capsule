...
use dig_capsule_compiler::{GenerationView, ResourceView};
use dig_capsule_core::{AuthenticationInfo, Bytes32, Bytes48, MetadataManifest, TrustedHostKey};
...
pub fn trusted_keys() -> Vec<TrustedHostKey> {
    let sk = dig_capsule_crypto::bls::BlsSecretKey::from_seed(&[42u8; 32]);
