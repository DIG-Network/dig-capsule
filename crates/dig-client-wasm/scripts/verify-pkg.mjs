// verify-pkg.mjs — gate the assembled `@dignetwork/dig-capsule` package (roadmap #16).
//
...
check("name is scoped", pkg.name === "@dignetwork/dig-capsule", pkg.name);
...
// exact `require("@dignetwork/dig-capsule")` path a Node consumer uses.
