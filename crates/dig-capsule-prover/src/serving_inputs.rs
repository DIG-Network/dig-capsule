...
impl ServingInputs {
    ...
    /// the single canonical ordering helper [`dig_capsule_core::serving::concat_output`]
...
mod tests {
    ...
    fn output_bytes_matches_core_concat_output_ordering() {
        // C9: ServingInputs::output_bytes() MUST equal dig_capsule_core::serving::concat_output
        ...
        let guest_style = dig_capsule_core::serving::concat_output(&refs);
