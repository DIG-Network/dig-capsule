...
use dig_capsule_core::types::{Bytes32, Bytes48, Bytes96};
use dig_capsule_crypto::bls::BlsSecretKey;
use dig_capsule_prover::{ChainSource, Prover};
use std::sync::Arc;
...
///
/// DEVIATION: `dig_capsule_crypto::bls::BlsSecretKey` is not `Clone`, and the
