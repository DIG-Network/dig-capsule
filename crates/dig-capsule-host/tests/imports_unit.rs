...
use dig_capsule_host::{ExecutionLimits, FixedClock, HostError, HostRuntime};
...
const TAG_LEN: usize = dig_capsule_core::ATTEST_DST.len();
...
fn write_challenge(rt: &mut HostRuntime, ptr: u32) {
    ...
    challenge[..TAG_LEN].copy_from_slice(dig_capsule_core::ATTEST_DST);
