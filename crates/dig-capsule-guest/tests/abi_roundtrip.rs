use dig_capsule_core::abi::{is_error, pack_ptr_len, unpack_ptr_len};
use dig_capsule_guest::packing::{guest_pack, guest_unpack};
...
use dig_capsule_guest::request::{ContentRequest, ProofRequest, ValidityWindow};
