...
//! `dig_capsule_core::datasection`. The guest does **not** define its own parser or
...
//!   * wraps `dig_capsule_core::datasection::DataView` in [`DataSection`] with the
...
//!     [`dig_capsule_core::datasection::DIGS_DATA_OFFSET`] (D2) on wasm.
//!
...
use alloc::vec::Vec;
use dig_capsule_core::datasection::{lookup_key as core_lookup_key, DataView};
use dig_capsule_core::Bytes32;
use dig_capsule_core::KeyTableEntry;
...
pub use dig_capsule_core::datasection::{encode_key_table, SectionId};
...
/// `dig_capsule_core::datasection::DataView`).
...
impl<'a> DataSection<'a> {
    ...
    ///
    /// [`DIGS_DATA_OFFSET`]: dig_capsule_core::datasection::DIGS_DATA_OFFSET
...
pub fn embedded<'a>() -> DataSection<'a> {
    use dig_capsule_core::datasection::DIGS_DATA_OFFSET;
