...
//! [`dig_capsule_core::datasection::DIGS_DATA_OFFSET`] (2 MiB), and the guest reads
...
//! [`dig_capsule_core::datasection::DIGS_DATA_OFFSET`] and places the heap at
...
fn heap_base_from_total_len(total_len: usize) -> usize {
    let off = dig_capsule_core::datasection::DIGS_DATA_OFFSET as usize;
...
mod tests {
    ...
    fn fallback_base_is_8mib_without_a_digs_header() {
        ...
        assert!(FALLBACK_HEAP_BASE > dig_capsule_core::datasection::DIGS_DATA_OFFSET as usize);
    }
